...
urlpatterns = [
    ...
    path('seleccion-registro/', views.seleccion_registro, name='seleccion_registro'),
    ...
    path('sala-espera/<int:id_partida>/', views.sala_espera, name='sala_espera'),
    path('reportes/socios-puntuales/', views.reporte_socios_puntuales, name='reporte_socios_puntuales'),
    path('reportes/liquidacion-bingo/<int:id_bingo>/', views.reporte_liquidacion_bingo, name='reporte_liquidacion_bingo'),
    path('reportes/cartera-prestamos/', views.reporte_cartera_prestamos, name='reporte_cartera_prestamos'),
    path('reportes/caja-semanal-pdf/', views.reporte_caja_semanal_pdf, name='reporte_caja_semanal_pdf'),

    # ==========================================
    # PARTIDA (El Motor del Juego en Vivo)
    # ==========================================
    # Vistas del Jugador
    path('juego/sala-espera/<int:id_partida>/', views.sala_espera, name='sala_espera_partida'),
    ...
    # COMPRA DE CARTONES
    # ==========================================
    path('juego/comprar-cartones/<int:id_partida>/', views.ventana_cartones, name='ventana_cartones'),
    path('api/partida/<int:id_partida>/comprar-cartones/', views.compra_carton_api, name='compra_carton_api'),

    # ==========================================
    # RECARGA DE SALDO
    # ==========================================
    path('recargar-saldo/', views.recargar_saldo, name='recargar_saldo'),
    path('api/recargar-saldo/', views.procesar_recarga_saldo, name='procesar_recarga_saldo'),
]
